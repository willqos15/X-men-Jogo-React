...
function Sobre () {
    return(<div className={styles.divgeral}>
        ...
        <div className={styles.divisoria}>
            <div className={styles.divisoriafoto}><img src={foto} className={styles.foto}/></div>
            <div className={styles.divisoriatexto}>
                <h3>Contato:</h3>
        <ul>
            <li> <a href="https://github.com/willqos15/X-menJogoBETA">Projeto no Github</a> </li>
            <li> <a href="https://wa.me/5593991878598">Whatsapp</a> </li>
            <li>  <a href="https://www.instagram.com/willqartes/">Instagram</a> </li>
        </ul>
